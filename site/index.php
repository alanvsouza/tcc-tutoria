...
<article id="cards-events"  class="col-lg-12 col-12 ">
    ...
    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-8 col-11" id="card1">
        <div class="card mb-3">
    ...
    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-8 col-11" id="card3">
        <div class="card mb-3">
            <img src="img/fundoLaranja.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Momento Desabafo</h5>
                    <hr>
